introSectionParaData = {
    "0": {
        "items": ["Best opinion sharing platform ! Just right for you"],
        "src" : "images/create-opinion.gif",
        "styles" : {
    ...
    "1": {
        "items": ["Everything at one place : edit, delete, modify", "You can subsbcribe feeds to get the notifications"],
        "src" : "images/feeds-1.jpg",
        "styles" : {
    ...
    "4": {
        "items": ["Why not try it out yourself"],
        "styles" : {
            "para": "background:radial-gradient(rgb(248 213 213), rgb(250 209 173)); width: 80%;",
            "container": "flex-direction: column; padding-bottom: 0px",
            "innerPara": {
                "0" : "text-align: center;"
            },
